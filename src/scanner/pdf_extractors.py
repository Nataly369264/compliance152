...
Architecture:
    ...
    YandexVisionExtractor → cloud OCR (TODO: session 1.2)
...
class YandexVisionExtractor:
    """OCR-based PDF extraction via Yandex Vision API.

    TODO: реализация в сессии 1.2.

    Currently a stub — always returns not_implemented without making HTTP calls.
    When implemented: convert PDF pages to images, send to Yandex Vision OCR,
    reassemble text. See DEC-004 for the rationale behind choosing Yandex Vision.
    """
