...
- Блог-фильтр Димы влит (2026-05-27): `/blog/`, `/articles/` и т.д. → `url_priority=0`
- Реструктуризация docs/ (2026-05-27, Марина): все `.md` переехали в `docs/journal/`, `docs/archive/`, `docs/`
