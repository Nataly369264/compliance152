...
- Score на el-ed.ru: **47%** (цель ~65%) — прогон v5 ещё не выполнен
...
1. Прогон `python tools/run_golden_scan.py` на el-ed.ru → сохранить как v5,
   сравнить diff: ожидаем POLICY_008 / POLICY_011 / POLICY_013 → True
2. Поднять score el-ed.ru до ~65% — устранить оставшиеся расхождения с golden set
3. Подготовка к первым пользователям — стабильность, обработка ошибок
